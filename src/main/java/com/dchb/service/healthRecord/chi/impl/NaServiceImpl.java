...
import com.dchb.mapper.healthRecord.chi.NaMapper;
 ...
 */
@Service
public class NaServiceImpl extends ServiceImpl<NaMapper, Na> implements NaService {
    /**
     ...
     */
    @Override
    public List<Map<String, Object>> getNaDateList(String ab) {
        QueryWrapper<Na> wrapper = new QueryWrapper();
     ...
     */
    @Override
    public Na getNaOne(String ab, String ad) {
        QueryWrapper<Na> wrapper = new QueryWrapper();
        wrapper.eq("ab", ab);
